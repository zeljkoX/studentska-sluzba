define(['backbone', 'text!sabloni/ispiti.html','hogan'], function(Backbone, Templates, Hogan) {
	var IspitiView = Backbone.View.extend({
		...
		initialize: function() {
			...
			Backbone.trigger('dugme', [{tekst: 'Dodaj Ispitni Rok', lokacija: 'ispiti/dodaj-ispit/', klasa: 'btn btn-success', ikona: 'icon-plus-sign icon-white'}]);
			Backbone.trigger('meni',[{tekst: 'Lista Ispita', lokacija: this.lokacija(), aktivan:'true'}]);
		},
		render: function() {
