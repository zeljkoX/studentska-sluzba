define(['backbone', 'text!sabloni/profesori.html','hogan'], function(Backbone, Templates, Hogan) {
	var ProfesoriView = Backbone.View.extend({
		...
		initialize: function() {
			...
			Backbone.trigger('dugme', [{tekst: 'Dodaj Profesora', lokacija: 'profesori/dodaj-profesor/', klasa: 'btn btn-success', ikona: 'icon-plus-sign icon-white'}]);
			Backbone.trigger('meni',[{tekst: 'Lista Profesora', lokacija: this.lokacija(), aktivan:'true'}]);
		},
		render: function() {
