define(['backbone', 'text!sabloni/studenti.html','hogan'], function(Backbone, Templates, Hogan) {
	var StudentiView = Backbone.View.extend({
		...
		initialize: function() {
			...
			Backbone.trigger('dugme', [{tekst: 'Dodaj Studenta', lokacija: 'studenti/dodaj-student/', klasa: 'btn btn-success', ikona: 'icon-plus-sign icon-white'}]);
			Backbone.trigger('meni',[{tekst: 'Lista Studenata', lokacija: this.lokacija(), aktivan:'true'}]);
		},
		render: function() {
